    ...
    if data_args.task_name is not None:
        ...
        if data_args.train_file is not None and data_args.validation_file is not None:
            ...
            for split, file_path in data_files.items():
                ...
                out_path = './data/hw1/'+ f'{split}.json'
        ...
        data_files = {'train': './data/hw1/train.json', 'validation': './data/hw1/validation.json'}
        ...
        for split in ['train', 'validation']:
            labels= [intent for intent in raw_datasets[split]["intent"]]
