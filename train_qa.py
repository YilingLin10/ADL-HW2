...
class DataTrainingArguments:
    ...
    relevant_file: Optional[str] = field(default=None, metadata={"help": "The relevant context file for testing."})
    context_file: Optional[str] = field(default=None, metadata={"help": "The input context file (a text file)."})
    pred_file: Optional[str] = field(default=None, metadata={"help": "The output prediction file (a text file)."})
...
def main():
    ...
    for split in ['train', 'validation']:
        context= [contexts[relevant] for relevant in raw_datasets[split]["relevant"]]
        answers=[{'text': [example['text']], 'answer_start':[example['start']]} for example in raw_datasets[split]["answer"]]
        raw_datasets[split] = raw_datasets[split].add_column('context', context)
        raw_datasets[split] = raw_datasets[split].add_column('answers', answers)
        raw_datasets[split] = raw_datasets[split].remove_columns('answer')
